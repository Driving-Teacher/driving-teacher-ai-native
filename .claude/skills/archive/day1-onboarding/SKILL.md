...
> **막히면 5분 이상 붙잡지 않고 다음으로** — 호스트(승아)에게 슬랙 #ai-native DM.
...
→ `2.0.0` 이상이면 OK. 미만이거나 명령어 없음 → 슬랙 #ai-native 에 OS와 함께 보고. 호스트가 화면 공유로 도움.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
다음 단계 (이 명령어가 안 보이면 슬랙 #ai-native DM):
...
3. **슬랙 `#ai-native`** — 화면 캡처 + 에러 메시지 함께 공유
